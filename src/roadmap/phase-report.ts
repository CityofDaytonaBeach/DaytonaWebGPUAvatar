...
export const START_MD_PHASES: PhaseMilestone[] = [
  ...
  phase(1, "Minimum human compiler", "IN_PROGRESS", ["schemaCompiler", "propertyIds", "gpuParameterBuffer", "dependencyGraph", "affectedSystemDiagnostics", "deltaCompiler", "vertexRangeCompilation", "gpuMorphCompute", "sparseMorph", "localizedEditBenchmark", "timelineDirtyReporting", "nonPropertyEventDirtyReporting"], ["generated schema artifacts", "CPU/GPU layout validation", "localized nose edit benchmark", "undo exactness proof"], ["add GPU timestamp benchmark path", "validate full Phase 1 suite once Node is available"]),
