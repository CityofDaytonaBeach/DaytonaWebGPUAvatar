...
export const START_MD_PHASES: PhaseMilestone[] = [
  ...
  phase(1, "Minimum human compiler", "IN_PROGRESS", ["schemaCompiler", "propertyIds", "gpuParameterBuffer", "dependencyGraph", "deltaCompiler", "gpuMorphCompute", "sparseMorph", "localizedEditBenchmark"], ["generated schema artifacts", "CPU/GPU layout validation", "localized nose edit benchmark", "undo exactness proof"], ["add GPU timestamp benchmark path", "harden dependency graph granularity"]),
  phase(2, "Canonical human", "PROTOTYPE", ["canonicalHuman", "canonicalParts"], ["licensed or original canonical topology", "stable vertex IDs", "face loops", "UV/surface coordinates", "replaceable asset boundary"], ["replace block human with production canonical topology interface"]),
