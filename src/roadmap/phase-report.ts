...
export const START_MD_PHASES: PhaseMilestone[] = [
  ...
  phase(2, "Canonical human", "PROTOTYPE", ["canonicalHuman", "canonicalValidation", "canonicalParts"], ["licensed or original canonical topology", "stable vertex IDs", "face loops", "UV/surface coordinates", "replaceable asset boundary"], ["replace block human with production canonical topology interface", "add canonical topology asset adapter"]),
