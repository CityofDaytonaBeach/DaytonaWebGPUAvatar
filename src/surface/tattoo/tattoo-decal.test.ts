...
describe("tattoo decal projection prototype", () => {
  ...
  it("filters non-tattoo attachments and requires region anchors", () => {
    ...
    expect(projectTattooDecal({ id: "shirt", kind: "wearable", anchor: { region: "torso" } }, canonical)).toBeNull();
    expect(() => projectTattooDecal({ id: "bad", kind: "tattoo", anchor: { bone: "head" } }, canonical)).toThrow(/region/);
  });
