...
import { resolveAnatomy, validateAnatomy, anatomySatisfaction } from './parametric-anatomy';
...
describe('parametric anatomy solver', () => {
  ...
  it('constraint solver flags an implausible waist', () => {
    const d = resolveAnatomy(
      makeDef({ 'body.waist': 1.8, 'body.chest': 0.6, 'body.bodyFat': 0.6 }),
    );
