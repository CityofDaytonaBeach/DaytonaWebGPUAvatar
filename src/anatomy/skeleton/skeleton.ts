...
export function defaultSkeleton(): BoneDef[] {
  return [
    ...
    { name: "pelvis", parent: "root", localPosition: { x: 0, y: 0.98, z: 0 }, restRotation: IDENTITY_QUAT },
    { name: "spine_01", parent: "pelvis", localPosition: { x: 0, y: 0.12, z: 0 }, restRotation: IDENTITY_QUAT },
    { name: "spine_02", parent: "spine_01", localPosition: { x: 0, y: 0.12, z: 0 }, restRotation: IDENTITY_QUAT },
    { name: "chest", parent: "spine_02", localPosition: { x: 0, y: 0.16, z: 0 }, restRotation: IDENTITY_QUAT },
    { name: "neck", parent: "chest", localPosition: { x: 0, y: 0.18, z: 0 }, restRotation: IDENTITY_QUAT },
    { name: "head", parent: "neck", localPosition: { x: 0, y: 0.16, z: 0 }, restRotation: IDENTITY_QUAT },
    { name: "clavicle_l", parent: "chest", localPosition: { x: -0.16, y: 0.19, z: 0 }, restRotation: IDENTITY_QUAT },
    { name: "clavicle_r", parent: "chest", localPosition: { x: 0.16, y: 0.19, z: 0 }, restRotation: IDENTITY_QUAT },
    { name: "upperarm_l", parent: "clavicle_l", localPosition: { x: -0.2, y: -0.05, z: 0 }, restRotation: IDENTITY_QUAT },
    { name: "upperarm_r", parent: "clavicle_r", localPosition: { x: 0.2, y: -0.05, z: 0 }, restRotation: IDENTITY_QUAT },
    { name: "forearm_l", parent: "upperarm_l", localPosition: { x: -0.02, y: -0.28, z: 0 }, restRotation: IDENTITY_QUAT },
    { name: "forearm_r", parent: "upperarm_r", localPosition: { x: 0.02, y: -0.28, z: 0 }, restRotation: IDENTITY_QUAT },
    { name: "hand_l", parent: "forearm_l", localPosition: { x: 0, y: -0.25, z: 0 }, restRotation: IDENTITY_QUAT },
    { name: "hand_r", parent: "forearm_r", localPosition: { x: 0, y: -0.25, z: 0 }, restRotation: IDENTITY_QUAT },
    { name: "thigh_l", parent: "pelvis", localPosition: { x: -0.09, y: -0.06, z: 0 }, restRotation: IDENTITY_QUAT },
    { name: "thigh_r", parent: "pelvis", localPosition: { x: 0.09, y: -0.06, z: 0 }, restRotation: IDENTITY_QUAT },
    { name: "shin_l", parent: "thigh_l", localPosition: { x: 0, y: -0.42, z: 0 }, restRotation: IDENTITY_QUAT },
    { name: "shin_r", parent: "thigh_r", localPosition: { x: 0, y: -0.42, z: 0 }, restRotation: IDENTITY_QUAT },
    { name: "foot_l", parent: "shin_l", localPosition: { x: 0, y: -0.4, z: 0.06 }, restRotation: IDENTITY_QUAT },
    { name: "foot_r", parent: "shin_r", localPosition: { x: 0, y: -0.4, z: 0.06 }, restRotation: IDENTITY_QUAT },
  ];
}
