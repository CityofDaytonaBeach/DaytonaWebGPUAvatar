import { CAPABILITY_MATRIX, } from '../roadmap/capability-matrix.js';
/**
...
export function kioskReadinessReport() {
    const entries = KIOSK_REQUIRED_CAPABILITIES.map((capability) => {
...
//# sourceMappingURL=kiosk-ready.js.map