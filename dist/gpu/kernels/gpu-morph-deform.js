...
export class GpuMorphDeform {
     ...
     */
    constructor(device, vertexCount, basePositions, deltaPacked, morphStruct) {
        this.device = device;
    ...
    writeWeights(morphStructBuffer) {
...
function makeParams(vertexCount, morphCount) {
    const view = new Uint32Array(4);
    view[0] = vertexCount;
    view[1] = morphCount;
    return new Uint8Array(view.buffer);
}
//# sourceMappingURL=gpu-morph-deform.js.map