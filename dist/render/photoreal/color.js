 ...
 */
export function acesFilmic(x) {
    const a = 2.51, b = 0.03, c = 2.43, d = 0.59, e = 0.14;
    return clamp01((x * (a * x + b)) / (x * (c * x + d) + e));
}
export function acesFilmic3(c) {
...
export function linearToSrgb3(c) {
    return [linearToSrgb(c[0]), linearToSrgb(c[1]), linearToSrgb(c[2])];
}
/** Full display transform: exposure -> ACES -> sRGB. */
export function toDisplay(linear, exposure = PHOTOREAL_CONSTANTS.exposure) {
