...
import { clamp01, vnormalize } from './color.js';
 ...
 */
export function microDetail(input) {
    ...
    const eps = 1e-3;
    const height = (u, v) => valueNoise2D(u * fPore, v * fPore) * (0.65 + 0.35 * age) +
 ...
 */
export function perturbNormal(normal, slopeX, slopeY) {
...
//# sourceMappingURL=micro-detail.js.map