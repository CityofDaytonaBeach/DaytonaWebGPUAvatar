...
import { PHOTOREAL_CONSTANTS, PHOTOREAL_FLAGS, PHOTOREAL_LIGHT_RIG, } from '../photoreal/constants.js';
...
${STUDIO_IRRADIANCE_SH.map((c) => `  ${v3(c)},`).join('\n')}
);
 ...
 */
export function photorealGBufferWgsl(base = PHOTOREAL_HUMAN_WGSL) {
...
//# sourceMappingURL=photoreal-wgsl.js.map