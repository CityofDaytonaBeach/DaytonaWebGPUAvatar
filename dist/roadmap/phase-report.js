...
export const START_MD_PHASES = [
    ...
    phase(7, 'Motion', 'COMPLETE', ['skeletalAnimation', 'motionCompiler', 'motionRuntime'], [
        'FK evaluator',
    ...
    phase(8, 'Surface systems', 'PROTOTYPE', [
        'tattooDecals',
        'neuralSkin',
    ...
    phase(13, 'Timeline and automation', 'COMPLETE', [
    ...
    phase(14, 'Kiosk readiness (talking-kiosk gate)', 'COMPLETE', [
        'kioskBlinkQuality',
        'kioskGazeBehavior',
        'kioskIdleMotion',
        'kioskInterruption',
    ...
    phase(15, 'Advanced R&D', 'PROTOTYPE', ['neuralSkin'], ['baseline comparisons', 'measured quality/performance benefit', 'portable fallback'], ['add baseline comparisons + portable fallback to neural skin']),
];
