import { multiplyMatrices } from '../../core/math/vec.js';
/**
 ...
 */
export function buildBoneMatrices(bones, poses = []) {
    const poseByName = new Map();
    for (const p of poses)
        poseByName.set(p.name, p);
 ...
 */
export function combinedSkinMatrices(bones, poses = []) {
...
export function composeMatrix(t, q) {
...
function write(buf, i, m) {
    buf.set(m, i * 16);
}
//# sourceMappingURL=bone-matrix.js.map