 ...
 */
export function resolveAnatomy(def) {
 ...
 */
export function validateAnatomy(d) {
    const out = [];
...
export function anatomySatisfaction(constraints) {
    if (constraints.length === 0)
        return 1;
    return constraints.reduce((s, c) => s + c.satisfaction, 0) / constraints.length;
}
//# sourceMappingURL=parametric-anatomy.js.map